...
from src import exploration as exp
from src import transformation as trf
...
#%%
df = exp.apertura_y_exploracion('../files/HR_RAW_DATA.csv')

#%%
df = trf.limpieza_datos(df)

#%%
df = trf.transformacion_datos(df)

#%%
df.to_csv("../files/df_to_SQL.csv")

#%%
df = trf.imputacion_nulos(df)

#%%
df.to_csv("../files/df_nulos_imputados.csv")
